...
public class ScanQrCodeActivity extends FragmentActivity {
    ...
    public void handleDecode(Result result) {
        ...
        if (result1.contains("uland.taobao.com")){
            //合法二维码——属于领卷联盟
            //跳转到淘口令界面
        ...
        //处理结果
        //https://uland.taobao.com/coupon/edetail?e=nGaMb2wfL4ENfLV8niU3R5TgU2jJNKOfNNtsjZw%2F%2FoJquONzcjQS3K4UvuGEH7otK48kY6MbxkBJKTHQYKz89FrisGmre1Id0BFAqRODu13Xn%2FhFIJzQ705f3KktoVY%2FXrtKHDVANPYrR%2F1y%2BmX0ge%2BFvIV2O8ZUf02K20hZG0WIagyTaQNPj0wNBUbTsArs&&app_pvid=59590_11.15.107.181_623_1586406753156&ptl=floorId:31539;app_pvid:59590_11.15.107.181_623_1586406753156;tpp_pvid:&union_lens=lensId%3AOPT%401586406753%400b0f6bb5_0dfb_1715d360421_94da%4001
//        if (mScannerListener == null) {
//            RxToast.success(result1);
//            //这里把他注释掉，不然返回结果就在弹窗里面处理了
